...
export default function About() {
  ...
  // Enhanced animation variants (unchanged)
  const fadeInUp = {
    hidden: { opacity: 0, y: 40 },
    visible: { 
      opacity: 1, 
  ...
  return (
    <>
      <Navbar />
      <main className="min-h-screen bg-gradient-to-b from-rose-50/30 via-white to-rose-50/20 "> {/* Added pt-16 for Navbar space */}
