...
const fetchSentInterests = async (senderId) => {
  try {
    const res = await fetch(`/api/interest/send?userId=${senderId}`);
    const data = await res.json();
    if (data.success) {
      return data.interests.map(i => i.receiver.id); // ⬅️ array of IDs where interest was sent
    }
    ...
    <>
      ...
      <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
        <motion.div 
          ...
          exit={{ opacity: 0, y: 20 }}
          transition={{ duration: 0.3, ease: "easeOut" }}
          className="bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-hidden shadow-2xl border border-orange-50 flex flex-col lg:flex-row"
        >
          {/* Fixed Left Side - Profile Image & Quick Stats */}
          <div className="w-full lg:w-1/3 p-4 border-r border-orange-50 bg-gradient-to-b from-orange-50/30 to-rose-50/30 flex flex-col items-center">
            {/* Close button for desktop */}
            ...
            <motion.div 
              ...
              className="w-full max-w-[240px] mx-auto mb-4 cursor-pointer"
            >
              <div className="aspect-[3/4] bg-gradient-to-br from-orange-100 to-rose-100 rounded-xl overflow-hidden shadow-lg relative group">
                {profile.profilePhoto ? (
                  <>
                    <img
                      src={profile.profilePhoto}
            ...
            <div className="w-full grid grid-cols-2 gap-2 mt-2">
              ...
              <div className="bg-rose-50 p-2 rounded-lg text-center">
                <p className="text-xs text-rose-600">Height</p>
                <p className="font-semibold text-rose-800">{profile.height}</p>
              </div>
              <div className="bg-purple-50 p-2 rounded-lg text-center">
                <p className="text-xs text-purple-600">City</p>
                <p className="font-semibold text-purple-800">{profile.currentCity}</p>
              </div>
              <div className="bg-indigo-50 p-2 rounded-lg text-center">
                <p className="text-xs text-indigo-600">Weight</p>
                <p className="font-semibold text-indigo-800">{profile.weight || '-'}</p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-2/3 overflow-y-auto flex flex-col">
            {/* Header for desktop */}
            <div className="hidden lg:flex sticky top-0 bg-gradient-to-r from-orange-50 to-rose-50 p-4 border-b border-orange-200 z-10">
              <div>
                <h3 className="text-xl font-bold text-orange-800">Profile Details</h3>
                <p className="text-sm text-orange-600">Compatibility: {profile.compatibility}% Match</p>
              </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-orange-50/50 to-transparent p-4 rounded-xl">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-slate-800">{profile.maritalStatus || '-'}</p>
                    </div>
                    <div>
                      <p className="text-xs text-slate-500">Mother Tongue</p>
                      <p className="font-medium text-slate-800">{profile.motherTongue || '-'}</p>
                    </div>
                    <div>
                      <p className="text-xs text-slate-500">Complexion</p>
                      <p className="font-medium text-slate-800">{profile.complexion || '-'}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-rose-50/50 to-transparent p-4 rounded-xl">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <p className="text-xs text-slate-500">Current City</p>
                      <p className="font-medium text-slate-800">{profile.currentCity || '-'}</p>
                    </div>
                    <div>
                      <p className="text-xs text-slate-500">Native City</p>
                      <p className="font-medium text-slate-800">{profile.nativeCity || '-'}</p>
                    </div>
                    <div className="col-span-2">
                      <p className="text-xs text-slate-500">Address</p>
                      <p className="font-medium text-slate-800">{profile.permanentAddress || '-'}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-purple-50/50 to-transparent p-4 rounded-xl">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <p className="text-xs text-slate-500">Highest Degree</p>
                      <p className="font-medium text-slate-800">{profile.education || '-'}</p>
                    </div>
                    <div>
                      <p className="text-xs text-slate-500">Field of Study</p>
                      <p className="font-medium text-slate-800">{profile.fieldOfStudy || '-'}</p>
                    </div>
                    <div className="col-span-2">
                ...
                <div className="bg-gradient-to-r from-rose-50/50 to-transparent p-4 rounded-xl">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <p className="font-medium text-slate-800">{profile.occupation || '-'}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="font-medium text-slate-800">{profile.income || '-'}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-purple-50/50 to-transparent p-4 rounded-xl">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-slate-800">{profile.mother || '-'}</p>
                    </div>
                    <div>
                      <p className="text-xs text-slate-500">Siblings</p>
                    ...
                    <div>
                      ...
                      <p className="font-medium text-slate-800">{profile.parentOccupation || '-'}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-rose-50/50 to-transparent p-4 rounded-xl">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <p className="font-medium text-slate-800">{profile.rashi || '-'}</p>
                    </div>
                    <div>
                      <p className="text-xs text-slate-500">Nakshira</p>
                      <p className="font-medium text-slate-800">{profile.nakshira || '-'}</p>
                    </div>
                    <div>
                      <p className="text-xs text-slate-500">Gotra/Devak</p>
                      <p className="font-medium text-slate-800">{profile.gotraDevak || '-'}</p>
                    </div>
                    <div>
                      <p className="text-xs text-slate-500">Mangal</p>
                      <p className="font-medium text-slate-800">{profile.mangal ? 'Yes' : 'No'}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            >
              {profile.profilePhoto ? (
                ...
                <div className="aspect-[3/4] bg-gradient-to-br from-orange-100 to-rose-100 rounded-lg flex items-center justify-center">
...
const MatchCard = ({ match }) => (
  <div className="bg-white rounded-xl shadow-lg border border-orange-50 hover:shadow-xl transition-all duration-300 overflow-hidden group">
    <div className="relative">
      {/* Mutual Match Banner */}
      {match.mutualMatch && (
        <div className="absolute top-0 left-0 right-0 bg-gradient-to-r from-green-500 to-emerald-600 text-white py-1 px-3 z-10">
      ...
      {/* Profile Image */}
     <div className={`aspect-[4/5] bg-gradient-to-br from-orange-50 to-rose-50 flex items-center justify-center relative ${match.mutualMatch ? 'mt-8' : ''}`}>
        {match.profilePhoto ? (
          <>
            <img
              src={match.profilePhoto}
        ...
        <div className="absolute top-1 left-1 flex flex-col space-y-1">
          ...
          {match.subscription?.plan === 'Premium' && (
            <div className="bg-gradient-to-r from-orange-400 to-rose-500 text-white px-1.5 py-0.5 rounded-full text-[10px] font-medium flex items-center">
              <Crown className="w-2.5 h-2.5 mr-0.5" />
              Premium
            </div>
          )}
      ...
      <div className="p-3">
        <div className="flex items-center justify-between mb-1">
          <h3 className="font-semibold text-slate-800 text-sm"> {hasSubscription ? match.name : maskFirstName(match.name)}</h3>
          <div className="flex items-center space-x-1">
            <Clock className="w-2.5 h-2.5 text-slate-400" />
            <span className="text-[10px] text-slate-500">{match.lastActive}</span>
          </div>
        </div>
...
<div className="flex space-x-1.5">
  <button 
    ...
    className="flex-1 bg-purple-50 text-purple-700 py-1 px-2 rounded text-xs font-medium hover:bg-purple-100 transition-colors"
  >
    <Eye className="w-3 h-3 mr-0.5 inline" />
    View
  </button>
  ...
  {match.mutualMatch ? (
    ...
    >
      <Heart className={`w-4 h-4 mr-1 ${match.interestSent ? 'fill-orange-600' : ''}`} />
      {match.interestSent ? 'Interest Sent' : 'Send Interest'}
    </button>
  ) : (
    <button 
      ...
      disabled={checkingSubscription}
      className={`flex-1 py-1 px-2 rounded text-xs font-medium ${
        checkingSubscription ? 'bg-slate-100' :
    ...
    <div className="text-center py-12">
      {isLoading ? (
        <div className="flex flex-col items-center justify-center">
          ...
          <h3 className="text-lg font-semibold text-slate-800 mb-2">Browsing matches...</h3>
        ...
        <>
          ...
          <button className="bg-gradient-to-r from-orange-500 to-rose-600 text-white px-6 py-2 rounded-lg font-medium hover:from-rose-500 hover:to-rose-600 transition-colors">
            Edit Preferences
          </button>
        </>
      )}
  ...
  <div className="min-h-screen bg-gradient-to-br from-rose-50 via-white to-purple-50">
    ...
    <div className="max-w-6xl mx-auto p-4 sm:p-6">
      {/* Header Section */}
      <div className={`transform transition-all duration-1000 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
        <div className="bg-gradient-to-r from-orange-500 to-rose-600 rounded-xl p-4 sm:p-6 text-white shadow-xl relative overflow-hidden mb-4 sm:mb-6">
          <div className="absolute top-0 right-0 w-24 h-24 sm:w-32 sm:h-32 bg-white/10 rounded-full blur-2xl"></div>
          <div className="relative z-10">
            <h1 className="text-xl sm:text-2xl font-bold mb-1 sm:mb-2">Your Personalized Matches</h1>
            <p className="text-rose-100 text-sm sm:text-base">Discover profiles selected just for you</p>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4 mb-4 sm:mb-6">
          ...
          <div className="relative w-full sm:w-64">
            ...
            <input
              type="text"
              placeholder="Search by city..."
              className="block w-full pl-10 pr-3 py-2 sm:py-3 border border-orange-200 rounded-lg bg-orange-50 shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-base"
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
            />
          </div>
...
`}</style>
      ...
      {/* Quick Filters & Sorting */}
      <div className={`transform transition-all duration-1000 delay-300 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
        <div className="bg-white rounded-xl shadow-lg border border-purple-50 p-4 mb-6">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1">
              <button
                onClick={() => setShowQuickFilters(!showQuickFilters)}
                className="flex items-center text-slate-700 hover:text-orange-600 transition-colors text-base"
              >
              ...
              {showQuickFilters && (
                <div className="mt-3 grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <select
                        ...
                        className="w-full px-2 py-1 border border-orange-200 rounded-md text-sm bg-orange-50"
                      >
                        <option value="">Min Age</option>
                        {Array.from({ length: 30 }, (_, i) => 18 + i).map(age => (
                          <option key={age} value={age}>{age}</option>
                  ...
                  {/* Height Range */}
<div className="col-span-2">
  <label className="block text-sm text-slate-600 mb-1">Height Range</label>
  <div className="flex items-center space-x-2">
    <select
      value={quickFilters.heightRange[0] || ''}
      onChange={(e) => setQuickFilters(prev => ({ 
...
{/* Education */}
<div className="col-span-2">
  <label className="block text-sm text-slate-600 mb-1">Education</label>
  <select
    value={quickFilters.education}
    onChange={(e) => setQuickFilters(prev => ({ ...prev, education: e.target.value }))}
    className="w-full px-2 py-1 border border-orange-200 rounded-md text-sm bg-orange-50"
            ...
            {filteredMatches.length > 0 && (
              <div className="text-center mt-8">
                <button
                  onClick={() => setIsLoading(true)}
                  disabled={isLoading}
                  className="bg-white border border-orange-300 text-orange-600 px-8 py-3 rounded-lg font-medium hover:bg-orange-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-base"
                >
                  {isLoading ? 'Loading...' : 'Load More Matches'}
                </button>
              </div>
