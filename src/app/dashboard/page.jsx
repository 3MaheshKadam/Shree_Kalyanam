...
export default function MatrimonialDashboard() {
  ...
  const getSubscriptionInfo = () => {
    ...
    return {
      ...
      color: isSubscribed && !isExpired ? 'bg-gradient-to-br from-orange-400 to-rose-500' : 'bg-gray-500'
    };
  };
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {!isLoaded ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <SkeletonCard height="h-64" className="lg:col-span-1" />
            <SkeletonCard height="h-64" className="lg:col-span-3" />
          </div>
        ) : (
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="bg-white rounded-xl p-6 shadow-lg border border-orange-50">
                <div className="text-center">
                  ...
                  <Link href="/dashboard/profile/me" className="w-full block bg-gradient-to-r from-orange-500 to-rose-600 text-white py-2 rounded-lg font-medium hover:from-rose-500 hover:to-rose-600 transition-all duration-300 text-center">
                    Edit Profile
                  </Link>
                </div>
              </div>
                ...
                <div className="bg-white rounded-xl p-6 shadow-lg border border-indigo-50">
                  ...
                  <div className="flex flex-col gap-4">
                    <Link href={"/dashboard/matches"} className="flex items-center p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors">
                      ...
                      <div className="text-left">
                        <div className="font-medium text-slate-900">Browse Matches</div>
                        <div className="text-sm text-slate-600">Find your perfect match</div>
                      </div>
                    </Link>
                    
                    <Link href={"/dashboard/interests"} className="flex items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
                      <UserPlus className="w-6 h-6 text-purple-500 mr-3" />
                      <div className="text-left">
                        <div className="font-medium text-slate-900">Interests</div>
                        <div className="text-sm text-slate-600">Manage interests</div>
                      </div>
                    </Link>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 shadow-lg border border-rose-50">
                  ...
                  <div className="space-y-4">
                    {recentActivity.map((activity, index) => {
                      ...
                      return (
                        <div key={index} className="flex items-start p-3 bg-rose-50/50 rounded-lg hover:bg-rose-100/50 transition-colors">
                          <Icon className={`w-5 h-5 ${iconColor} mr-3 flex-shrink-0 mt-0.5`} />
                          <div className="flex-1">
                            <div className="font-medium text-slate-900 text-sm">{activity.message}</div>
