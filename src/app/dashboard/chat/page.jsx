...
export default function ChatSection() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-rose-50 via-white to-purple-50 p-6">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          {/* Header */}
          <div className={`transform transition-all duration-1000 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
            <div className="bg-gradient-to-r from-orange-500 to-rose-600 rounded-2xl p-8 shadow-xl relative overflow-hidden text-white">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-rose-100">Connect with your mutual matches</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Coming Soon Section */}
          <div className={`transform transition-all duration-1000 delay-100 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
            <div className="bg-white rounded-xl p-8 shadow-lg border border-orange-50 text-center hover:shadow-xl transition-shadow duration-300">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-white to-purple-50 flex flex-col">
      {/* Chat Header */}
      <div className="bg-white shadow-lg border-b border-orange-50 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <button
      ...
      <div className="flex-1 max-w-4xl mx-auto w-full px-6 py-4 overflow-y-auto">
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg border border-purple-50 text-center hover:shadow-xl transition-shadow duration-300 mt-12">
      ...
      {/* Message Input */}
      <div className="bg-white border-t border-orange-50 sticky bottom-0">
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex items-center space-x-3">
            <div className="flex-1 relative">
              <input
                ...
                type="text"
                placeholder="Feature coming soon..."
                className="w-full px-4 py-3 pr-12 border border-orange-200 rounded-full bg-orange-50 text-slate-600"
              />
            </div>
            
            <button
              disabled
              className="p-3 rounded-full bg-orange-50 text-orange-400"
            >
              <Send className="w-5 h-5" />
            </button>
          </div>
