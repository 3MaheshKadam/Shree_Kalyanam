  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-white to-purple-50 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* Welcome Section */}
        <div className={`transform transition-all duration-1000 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
          <div className="bg-gradient-to-r from-orange-500 to-rose-600 rounded-2xl p-6 text-white shadow-xl relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full blur-2xl"></div>
            <div className="absolute bottom-0 left-0 w-24 h-24 bg-white/5 rounded-full blur-xl"></div>
            <div className="relative z-10">
              <div className="flex items-center justify-between">
                <div>
                  <h1 className="text-2xl font-bold mb-2">Welcome back, {user?.name || 'Priya'}! 👋</h1>
                  <p className="text-rose-100">Your perfect match is just a click away</p>
                </div>
                <div className="hidden md:block">
                  <Sparkles className="w-12 h-12 text-rose-200" />
        ...
        <div className={`grid grid-cols-1 lg:grid-cols-4 gap-6 transform transition-all duration-1000 delay-200 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
          {/* Left Sidebar: Profile & Subscription */}
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-orange-50">
              <div className="text-center">
                ...
                <h3 className="font-bold text-slate-800 text-lg mb-1">{user?.name || 'Priya Sharma'}</h3>
                ...
                <button className="w-full bg-gradient-to-r from-orange-500 to-rose-600 text-white py-2 rounded-lg font-medium hover:from-rose-500 hover:to-rose-600 transition-all duration-300">
                  Edit Profile
                </button>
              </div>
            </div>
            ...
            {/* Subscription Status */}
            <div className="bg-gradient-to-br from-orange-400 to-rose-500 rounded-xl p-6 shadow-lg text-white">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-semibold">Premium Plan</h3>
                <Crown className="w-5 h-5 text-yellow-200" />
              </div>
          ...
          {/* Right Content: Stats, Matches, Activity */}
          <div className="lg:col-span-3 space-y-6">
            {/* Stats Row */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Profile Completion */}
              <div className="bg-white rounded-xl p-6 shadow-lg border border-purple-50 hover:shadow-xl transition-all duration-300">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-semibold text-slate-800">Profile Status</h3>
                  <User className="w-5 h-5 text-rose-500" />
                </div>
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div 
                      className="bg-gradient-to-r from-orange-500 to-rose-600 h-2 rounded-full transition-all duration-1000"
                      style={{ width: `${profileCompletion}%` }}
                    ></div>
                  </div>
              ...
              {/* Total Matches */}
              <div className="bg-white rounded-xl p-6 shadow-lg border border-rose-50 hover:shadow-xl transition-all duration-300">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-semibold text-slate-800">Total Matches</h3>
                  <Heart className="w-5 h-5 text-rose-500" />
                </div>
                <div className="space-y-2">
              ...
              {/* Profile Views */}
              <div className="bg-white rounded-xl p-6 shadow-lg border border-indigo-50 hover:shadow-xl transition-all duration-300">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-semibold text-slate-800">Profile Views</h3>
                  <Eye className="w-5 h-5 text-rose-500" />
                </div>
                <div className="space-y-2">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-orange-50">
              <div className="flex items-center justify-between mb-6">
                <h3 className="font-bold text-slate-800 text-lg">Quick Match Suggestions</h3>
                <button className="flex items-center text-rose-600 hover:text-rose-700 font-medium">
                  View All
                  <ArrowRight className="w-4 h-4 ml-1" />
                </button>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                {quickMatches.map((match) => (
                  <div key={match.id} className="border border-gray-200 rounded-lg p-4 hover:border-rose-300 hover:shadow-md transition-all duration-300">
                    <div className="flex items-center justify-between mb-3">
                      <div className="w-12 h-12 bg-gradient-to-br from-orange-100 to-rose-100 rounded-full flex items-center justify-center">
                        <User className="w-6 h-6 text-rose-500" />
                      </div>
                      <div className="flex items-center">
                        <Star className="w-4 h-4 text-yellow-500 mr-1" />
                        <span className="text-sm font-medium text-slate-700">{match.compatibility}%</span>
                      </div>
                    </div>
                    <h4 className="font-semibold text-slate-900 mb-1">{match.name}</h4>
                    <p className="text-sm text-slate-600 mb-3">{match.age} years • {match.location}</p>
                    <div className="flex space-x-2">
                      <button className="flex-1 bg-rose-50 text-rose-600 py-2 px-3 rounded-lg text-sm font-medium hover:bg-rose-100 transition-colors">
                        <Heart className="w-4 h-4 inline mr-1" />
                        Interest
                      </button>
                      <button className="flex-1 bg-gray-50 text-slate-600 py-2 px-3 rounded-lg text-sm font-medium hover:bg-gray-100 transition-colors">
                        View
                      </button>
                    </div>
                  </div>
        ...
        {/* Activity & Interests Row */}
        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-6 transform transition-all duration-1000 delay-400 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
          
          {/* Recent Activity */}
          <div className="bg-white rounded-xl p-6 shadow-lg border border-purple-50">
            <div className="flex items-center justify-between mb-6">
            ...
            <div className="space-y-4">
              {recentActivity.map((activity, index) => {
                const Icon = activity.icon;
                const iconColor = 
                  activity.type === "view" ? "text-indigo-500" :
                  activity.type === "interest" ? "text-rose-500" :
                  activity.type === "match" ? "text-purple-500" :
                  "text-orange-500";
                return (
                  <div key={index} className="flex items-start space-x-3 p-3 rounded-lg hover:bg-rose-50/50 transition-colors">
                    <div className="flex-shrink-0 w-8 h-8 bg-rose-100 rounded-full flex items-center justify-center">
          ...
          {/* Interests Overview */}
          <div className="bg-white rounded-xl p-6 shadow-lg border border-rose-50">
            <h3 className="font-bold text-slate-800 text-lg mb-6">Interests Overview</h3>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center">
                  ...
                  <div className="ml-3">
                    <p className="font-medium text-slate-900">Interests Received</p>
                    <p className="text-sm text-slate-600">People interested in you</p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-2xl font-bold text-green-600">23</div>
                  <div className="text-xs text-slate-500">New: 5</div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="font-medium text-slate-900">Interests Sent</p>
                    <p className="text-sm text-slate-600">Your sent interests</p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-2xl font-bold text-blue-600">12</div>
                  <div className="text-xs text-slate-500">Pending: 8</div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-rose-50 rounded-lg">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <p className="font-medium text-slate-900">Mutual Matches</p>
                    <p className="text-sm text-slate-600">Perfect connections</p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-2xl font-bold text-rose-600">7</div>
        ...
        {/* Quick Actions */}
        <div className={`transform transition-all duration-1000 delay-500 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
          <div className="bg-gradient-to-r from-orange-500 to-rose-600 rounded-xl p-6 text-white shadow-xl">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="mb-4 md:mb-0">
                <h3 className="font-bold text-xl mb-2">Ready to find your perfect match?</h3>
                <p className="text-rose-100">Explore personalized matches based on your preferences</p>
