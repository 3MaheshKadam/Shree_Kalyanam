      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`max-w-lg transition-all duration-1000 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            {/* QR Code option */}
            <div className="flex items-center p-4 bg-rose-800/30 rounded-xl border border-rose-700/30 backdrop-blur-sm">
              <div className="w-14 h-14 bg-white p-1 rounded-lg shadow-md mr-4 flex-shrink-0">
                <Image
                  width={56}
                  height={56}
                  src="/qr.png" 
              ...
              <div>
                <p className="text-rose-100/90 text-sm">Scan to download</p>
                <button className="flex items-center text-amber-300 text-sm font-medium mt-1 hover:text-amber-200 group">
                  More options <ChevronRight size={16} className="ml-1 transform group-hover:translate-x-1 transition-transform duration-200" />
                </button>
              </div>
            </div>
          </div>
