        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`max-w-lg transition-all duration-1000 transform ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <p className="text-white/80 text-lg mb-8">
              Experience seamless matchmaking with the Shree Kalyanam app. Stay connected with prospective families, manage your profile, and find your soulmate with our secure and intuitive mobile experience.
            </p>
