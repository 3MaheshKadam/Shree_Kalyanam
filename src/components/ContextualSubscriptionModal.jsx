        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                ...
                >
                    ...
                    <div className="bg-gradient-to-br from-rose-500 to-amber-500 p-8 text-center relative overflow-hidden">
                        ...
                        <p className="text-rose-100 text-sm">Someone interested in you is waiting...</p>
                    </div>
                    ...
                    <div className="p-6">
                        <div className="mb-6 bg-rose-50 border border-rose-100 rounded-xl p-4">
                            ...
                            <div className="flex items-center text-rose-600 text-xs font-semibold mt-2">
                        ...
                        <button
                            ...
                            className="w-full bg-gradient-to-r from-rose-500 to-amber-500 text-white font-bold py-3.5 rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-200 flex items-center justify-center"
                        >
